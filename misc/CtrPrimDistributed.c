...
CObjInterface(EBBCtr)
  ...
  o->ft = &EBBCtrPrimDistributed_ftable;
     ...
     static EBBRC
       ...
       for (node = self->theRoot->ft->nextRep(self->theRoot, 0, &rep); node;
     ...
     static void *EBBCtrPrimDistributed_createRep(CObjEBBRootMultiRef rootRef) {
     ...
     .inc = EBBCtrPrimDistributed_inc,.dec =
	 EBBCtrPrimDistributed_dec,.val = EBBCtrPrimDistributed_val};
