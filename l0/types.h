...
typedef EBBRC (*EBBMissFunc) (void *, EBBLTrans *, FuncNum, EBBMissArg);

// FIXME: Not sure if the type of the 2nd arg should be something different
static inline void
EBBCacheObj(EBBLTrans * lt, void *obj) {
...
EBBIdToSpecificLTrans(EBBId id, uval i) {
  return (EBBLTrans *) ((uval) id +
			i * EBB_TRANS_PAGE_SIZE * EBB_TRANS_NUM_PAGES);
}
